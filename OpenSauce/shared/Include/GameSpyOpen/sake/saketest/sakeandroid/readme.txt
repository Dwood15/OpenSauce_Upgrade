...
GameSpy Technology is pleased to provide its Sake cloud storage client to game
developers on the Android platform. This ReadMe and the files in this directory
support the Sake test app for Android. The test app can serve as a guide in
implementing and testing GameSpy storage services via NativeActivity Mode
in your Android games.
...
1. The main Sake client file for Android (saketest.c), providing Sake 
   functionality for Android projects.
2. An Android.mk file written for the Sake test client for Android projects.
3. The Application.mk file designating the application platform version.

-------------------------------------
Other Files in the SakeAndroid Folder:
-------------------------------------
...
The following code changes are required for porting sample applications for Sake 
to NativeActivity:

We have added the event-handler as described in the previous section. In the case of 
Sake, the shutdown code is: 
...
4.  Browse to the ./sake/saketest/sakeandroid/ directory.
5.  Select Finish.
