...
void GamePlayer::ObtainAuthServiceCertificate(const gsi_char *email, const gsi_char *profile,
											const gsi_char *password, int partnerSpaceId, int nameSpaceId)
{
	...
	WSLoginValue loginVal = wsLoginProfile(m_Data.m_GameId, partnerSpaceId, nameSpaceId, profile,
...
void GamePlayer::ObtainAuthServiceCertificate(const gsi_char *partnerChallenge, const gsi_char *remoteAuthToken,
											int partnerSpaceId, int nameSpaceId)
{
	...
	// that happen after scInitialize.  
	_tprintf(_T("Obtaining auth service certificate...\n"));
	WSLoginValue loginVal = wsLoginRemoteAuth(m_Data.m_GameId, partnerSpaceId, nameSpaceId, remoteAuthToken,
