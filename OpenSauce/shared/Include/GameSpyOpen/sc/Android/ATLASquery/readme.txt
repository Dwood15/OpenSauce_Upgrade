...
1. The main ATLASquery client file for Android, providing ATLAS query 
   functionality for Android projects.
2. An Android.mk file written for the ATLASquery test client for Android projects.
3. The Application.mk file designating the application platform version.

-----------------------------------------------
Other Files in the ATLASquery Android Folder:
-----------------------------------------------
...
4.  Browse to the ./sc/Android/ATLASquery/ directory.
5.  Select Finish.
