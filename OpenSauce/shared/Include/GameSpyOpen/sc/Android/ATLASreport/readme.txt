...
Copyright (c) 2009 - 2012 GameSpy Technology / IGN, Inc.

========
Overview
========

GameSpy Technology is pleased to provide its ATLAS Stats and Tracking client to game
developers on the Android platform. This ReadMe and the files in this directory
support the ATLAS test app for Android. The test app can serve as a guide in
...
1. The main ATLASreport client file for Android, providing ATLAS report 
   functionality for Android projects.
2. An Android.mk file written for the ATLASreport test client for Android projects.
3. The Application.mk file designating the application platform version.

-----------------------------------------------
Other Files in the ATLASreport Android Folder:
-----------------------------------------------
...
4.  Browse to the ./sc/Android/ATLASreport/ directory.
5.  Select Finish.
...
+-OpenSDK\
  +-sc\
    +-Android\
      +-atlas_ruleset_atlasSamples_v2.xml
      +-sampleCommon.c
      +-sampleCommon.h
      +-ATLASreport\
        +-jni\
          +-Android.mk
          +-atlas_atlasSamples_v2.c
          +-atlas_atlasSamples_v2.h
          +-sampleReportStats.c
