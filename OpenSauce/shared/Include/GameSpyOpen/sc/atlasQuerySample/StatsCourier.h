...
public:
	...
	void ObtainAuthServiceCertificate(const gsi_char *email, const gsi_char *profile, 
									  const gsi_char *password, int partnerSpaceId, int nameSpaceId);	
	void ObtainAuthServiceCertificate(const gsi_char *partnerChallenge, const gsi_char *remoteAuthToken, 
