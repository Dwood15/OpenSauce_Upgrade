...
void StatsCourier::ObtainAuthServiceCertificate(const gsi_char *email, const gsi_char *profile,
												const gsi_char *password, int partnerSpaceId, int nameSpaceId)
{
	...
	WSLoginValue loginVal = wsLoginProfile(m_Data.gameId, partnerSpaceId, nameSpaceId, profile,
		email, password, NULL, OnObtainAuthServiceCertificate, this);
...
void StatsCourier::ObtainAuthServiceCertificate(const gsi_char *partnerChallenge, const gsi_char *remoteAuthToken,
											int partnerSpaceId, int nameSpaceId)
{
	...
	// Use this function to obtain an AuthService certificate for all ATLAS calls 
	// that happen after scInitialize
	WSLoginValue loginVal = wsLoginRemoteAuth(m_Data.gameId, partnerSpaceId, nameSpaceId, remoteAuthToken,
		partnerChallenge, OnObtainAuthServiceCertificate, this);
