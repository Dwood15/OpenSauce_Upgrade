...
#define SC_SERVICE_URL_FORMAT					"https://" GSI_OPEN_DOMAIN_NAME "/ATLAS/SubmissionService/2.0/SubmissionService.asmx"
char scServiceURL[SC_SERVICE_MAX_URL_LEN] = "";
#define SC_GAME_CONFIG_DATA_SERVICE_URL_FORMAT	"https://" GSI_OPEN_DOMAIN_NAME "/ATLAS/DataService/2.0/GameConfig.asmx"
char scGameConfigDataServiceURL[SC_SERVICE_MAX_URL_LEN] = "";
#define SC_STATS_DATA_SERVICE_URL_FORMAT		"https://" GSI_OPEN_DOMAIN_NAME "/ATLAS/DataService/2.0/StatisticsService.svc"
char scStatsDataServiceURL[SC_SERVICE_MAX_URL_LEN] = "";
...
SCResult sciInterfaceCreate(SCInterface** theInterfaceOut)
{
	...
	if (__GSIACResult == GSIACAvailable)
	{
		...
		if (scStatsDataServiceURL[0] == '\0')
			snprintf(scStatsDataServiceURL, SC_SERVICE_MAX_URL_LEN, SC_STATS_DATA_SERVICE_URL_FORMAT, __GSIACGamename);
	}
	else
