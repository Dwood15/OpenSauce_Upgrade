...
void     sciWsCheckBanListCallback(
...
SCResult sciWsSerializeStatsQuery(
...
void	sciWsGameStatsQueryCallback(
	GHTTPResult			httpResult,
	GSXmlStreamWriter	requestData,
	GSXmlStreamReader	responseData,
	void				* userData
...
void	sciWsPlayerStatsQueryCallback(
	GHTTPResult			httpResult,
	GSXmlStreamWriter	requestData,
	GSXmlStreamReader	responseData,
	void				* userData
...
void	sciWsTeamStatsQueryCallback(
	GHTTPResult			httpResult,
	GSXmlStreamWriter	requestData,
	GSXmlStreamReader	responseData,
	void				* userData
...
SCResult sciWsRunGameStatsQuery(
	SCWebServices					* webServices,
	gsi_u32							gameId, 
	const GSLoginCertificate		* certificate, 
	const GSLoginPrivateData		* privateData, 
...
SCResult sciWsRunPlayerStatsQuery(
	SCWebServices					* webServices,
	gsi_u32							gameId,
	const GSLoginCertificate		* certificate,
	const GSLoginPrivateData		* privateData,
...
SCResult sciWsRunTeamStatsQuery(
	SCWebServices					* webServices,
	gsi_u32							gameId,
	const GSLoginCertificate		* certificate,
	const GSLoginPrivateData		* privateData,
