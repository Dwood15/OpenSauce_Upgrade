...
#define gpConnectLoginTicket		gpConnectLoginTicketW
...
///////////////////////////////////////////////////////////////////////////////
// gpConnectLoginTicket
// Summary
//		This function is used to establish a connection to the server. It 
//		establishes a connection with a login ticket passed from some other 
//		GameSpy system or SDK.
// Parameters
//      connection	: [in] A GP connection object initialized with 
//							gpInitialize.
//      loginticket	: [in] The login ticket.
//      firewall   	: [in] GP_FIREWALL or GP_NO_FIREWALL. This option may limit 
//							the user's ability to transfer files. 
//      blocking  	: [in] GP_BLOCKING or GP_NON_BLOCKING  
//      callback  	: [in] A user-supplied callback with an arg type of 
//							GPConnectResponseArg.
//      param  		: [in] Pointer to user-defined data. This value will be 
...
//		called.
// Note
//		gpConnectLoginTicketW and gpConnectLoginTicketA are UNICODE and ANSI 
//		mapped versions of gpConnectLoginTicket. The arguments of 
//		gpConnectLoginTicketA are ANSI strings; those of
//		gpConnectLoginTicketW are wide-character strings.
// See Also 
//      GPConnectResponseArg
...
//		maxBuddies	: [in] The maximum number of buddies to return. If 0 is 
//							passed in, all buddies will be returned. 
//		blocking	: [in] GP_BLOCKING or GP_NON_BLOCKING 
...
// Remarks
//      This function returns a valid GPResult. Common return values are: 
//		<p />
...
// gpSetQuietMode
// Summary
//		Turn on or off the flags that control what types of buddy messages 
//		the local profile will receive.
// Parameters
//		connection	: [in] A GP connection object initialized with 
//							gpInitialize. 
//		flags		: [in] A bitwise OR of the GP_SILENCE_ flags of GPEnum.
// Returns 
//      GPResult is described in the GP enums section.
// Remarks
//		This function sets the types of buddy messages that the local profile
//		will receive. 
//      This function returns a valid GPResult. Common return values are: 
//		<p />
//		GP_NO_ERROR on success. <p />
...
// GPNpBasicCallback
// Summary
//		A generic NP Basic callback function type used to specify the callback 
//		supplied to GP SDK with gpRegisterNpBasicEventCallback.
// Parameters
//		incomeEvent	: [in] Event type (SCE_NP_BASIC_EVENT_XXX)
//		retCode		: [in] Error code
//		reqId       : [in] Request ID 
//		arg 		: [in] The user-data, if any, that was passed into the 
//							function that triggered this callback event.
// Remarks
//		This callback notifies the developer to take action on an incoming NP 
//		Basic event. Do not call sceNpBasicGetEvent within the function 
//		registered using gpRegisterNpBasicEventCallback; instead flag this 
//		event, and call sceNpBasicGetEvent from a separate event handling 
//		thread. This restriction is in accordance with Sony Documentation.
//		English Docs: https://ps3.scedev.net/docs/ps3-en/1
// See Also
//		gpRegisterNpBasicEventCallback
typedef int (*GPNpBasicEventCallback)(
	int incomeEvent,
	int retCode, 
	uint32_t reqId, 
	void *arg
...
// gpRegisterNpBasicEventCallback
// Summary
//		Registers a developer specified callback to handle events for PS3 NP 
//		Basic.
// Parameters
//		connection	: [in] A GP connection object initialized with 
//							gpInitialize. 
...
//		GPResult is returned.
// Remarks
//      This function sets the callback to call when there is a pending PS3 NP 
//		Basic event. If no callback is set, then no alert will be given when a 
//		Basic event occurs. 
//		<p />
//		If this callback is registered, make a call to sceNpBasicGetEvent after 
//		receiving the callback (but not within the callback) to clear the event
//		from the queue. Please refer to Sony PS3 NP Basic documentation for 
//		this function and SceNpBasicEventHandler.
//      English Docs: https://ps3.scedev.net/docs/ps3-en/1
GPResult gpRegisterNpBasicEventCallback(
	GPConnection *connection,
...
//		connection	: [in] A GP connection object initialized with 
//							gpInitialize. 
//		communicationId	: [in] The Sony-provided Communication ID (4 alphabetic 
//								characters and 5 numerical characters). 
// Returns 
//      This function returns GP_NO_ERROR on success. Otherwise a valid 
//		GPResult is returned.
// Remarks
//      This must be called after initializing GP to set the Communication ID 
//		as per Sony requirement. Please refer to Sony PS3 NP documentation for 
//		the SceNpCommunicationId structure description.
//      English Docs: https://ps3.scedev.net/docs/ps3-en/1
GPResult gpSetNpCommunicationId(
	GPConnection *connection, 
...
// gpRegisterNpBasicEventCallback
// Summary
//		Sets the slot number for GP to use when registering the cellSysutil 
//		callback.
// Parameters
//		connection	: [in] A GP connection object initialized with 
//							gpInitialize. 
//		slotNum 	: [in] Slot number for GPs cellSysutil callback (0-3); 
//							make sure this does not overlap with your own slot 
//							number passed to cellSysutilRegisterCallback.  
// Returns 
//      This function returns GP_NO_ERROR on success. Otherwise a valid 
//		GPResult is returned.
// Remarks
//      This function must be called before you connect GP (e.g., gpConnect).
//		Please refer to Sony PS3 documentation for info on the 
//		cellSysutilRegisterCallback function. 
//		English Docs: https://ps3.scedev.net/docs/ps3-en/1
GPResult gpRegisterCellSysUtilCallbackSlot(
	GPConnection *connection, 
	int slotNum
);
