...
#if defined(_LINUX) || defined(_MACOSX) || defined (_IPHONE) || defined(ANDROID)
	#define _UNIX
#endif
...
#include <assert.h>
...
#if defined(_PSP) || defined(_PSP2) || defined(_NITRO) || defined(_IPHONE)
	...
	#define GSI_OPEN_DOMAIN_NAME_UNI _T("%ls.api.gamespy.net") // unicode supported string blehhh
#else
