...
CFLAGS=$(BASE_CFLAGS) $(UNICODE_CFLAGS) -D_MACOSX -D_NO_NOPORT_H_ -g -O0 -Wall 
endif
...
# library paths
ifeq ($(DEBUG),yes)
	LIBDIR = $(SRCROOT)/../libs/AuthService/macosxDebug
else
	LIBDIR = $(SRCROOT)/../libs/AuthService/macosxRelease
endif
