...
namespace Yelo {
	...
	namespace Enums {
		enum {
			...
			k_maximum_hs_syntax_nodes_per_scenario_upgrade= CAST(uint32, k_maximum_hs_syntax_nodes_per_scenario * K_MEMORY_UPGRADE_INCREASE_AMOUNT),
			k_maximum_hs_string_data_per_scenario_upgrade= CAST(uint32, k_maximum_hs_string_data_per_scenario * K_MEMORY_UPGRADE_INCREASE_AMOUNT),
	...
	namespace Enums {
		enum {
			...
			k_max_cache_size_upgrade= CAST(uint32, k_max_cache_size * K_MEMORY_UPGRADE_INCREASE_AMOUNT),

			k_max_cache_vertex_y_index_buffer_size_upgrade= CAST(uint32, k_max_cache_vertex_y_index_buffer_size * K_MEMORY_UPGRADE_INCREASE_AMOUNT),
		};
