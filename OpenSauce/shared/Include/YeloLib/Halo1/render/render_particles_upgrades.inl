...
namespace render_particles_mods
{
	struct s_rendered_particle
	{
		...
		PAD8;
	}; static_assert(sizeof(s_rendered_particle) == 8, STATIC_ASSERT_FAIL);
	...
	{
		Memory::c_naked_func_writer<lea_ecx_rendered_particles_mul8>::Write( K_RENDER_PARTICLES_RENDERED_PARTICLES_ARRAY_ADDRESS_LIST[0] );
		Memory::c_naked_func_writer<lea_eax_rendered_particles_mul8>::Write( K_RENDER_PARTICLES_RENDERED_PARTICLES_ARRAY_ADDRESS_LIST[1] );
		Memory::c_naked_func_writer<lea_ecx_rendered_particles>::Write( K_RENDER_PARTICLES_RENDERED_PARTICLES_ARRAY_ADDRESS_LIST[2] );
		Memory::c_naked_func_writer<lea_eax_rendered_particles_add4>::Write( K_RENDER_PARTICLES_RENDERED_PARTICLES_ARRAY_ADDRESS_LIST[3] );
		Memory::c_naked_func_writer<lea_eax_rendered_particles>::Write( K_RENDER_PARTICLES_RENDERED_PARTICLES_ARRAY_ADDRESS_LIST[4] );

		*CAST_PTR(size_t*, GET_FUNC_VPTR(GAME_INITIALIZE_MOD_PER_MAP_UPGRADE_PARTICLES)) = Enums::k_maximum_number_of_particles_per_map_upgrade;
	}
