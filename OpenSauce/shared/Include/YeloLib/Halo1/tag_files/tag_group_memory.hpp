...
namespace Yelo
{
	...
	namespace TagGroups
	{
		...
		public:
			...
			static bool Enabled();
		}; static_assert(sizeof(s_tag_field_set_runtime_data) == 0x1C, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(field_comparison_code) == 0x4);
		...
		}; static_assert( sizeof(s_tag_allocation_header) == 0x10 );
