...
#include <PshPack4.h>
	...
	class c_type_container abstract : public Configuration::c_configuration_container {
	protected:
		Type m_value;
	...
	public:
		...
		c_type_container(std::string& name) : Configuration::c_configuration_container(name) { }
		...
		///
		/// <returns>	The wrapped value. </returns>
		const Type& GetConst() const { return m_value; }
