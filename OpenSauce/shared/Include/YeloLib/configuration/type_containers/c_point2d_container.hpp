...
namespace Yelo::Configuration {
	...
	class c_point2d_container : public Configuration::c_type_container<point2d> {
	private:
	...
	public:
		...
		c_point2d_container(std::string& name, int16 default_x, int16 default_y);

		////////////////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>	Initializes a new instance of the c_point2d_container class. </summary>
		///
		/// <param name="name">	The configuration node name for the value. </param>
		c_point2d_container(std::string& name);
