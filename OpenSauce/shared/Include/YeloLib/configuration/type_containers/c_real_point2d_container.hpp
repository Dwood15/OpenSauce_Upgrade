...
namespace Yelo::Configuration {
	...
	class c_real_point2d_container : public Configuration::c_type_container<real_point2d>
	{
	private:
	...
	public:
		...
		c_real_point2d_container(std::string& name, real default_x, real default_y);

		////////////////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>	Initializes a new instance of the c_real_point2d_container class. </summary>
		///
		/// <param name="name">	The configuration node name for the value. </param>
		c_real_point2d_container(std::string& name);
