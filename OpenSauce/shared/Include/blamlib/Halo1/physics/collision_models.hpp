...
namespace Yelo
{
	namespace Physics
	{
		...
		}; static_assert(sizeof(s_collision_model_instance) == 0x10, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_collision_model_test_vector_result) == 0x420, STATIC_ASSERT_FAIL);
	};
};