...
namespace Yelo
{
	...
	namespace Objects
	{
		...
		}; static_assert(sizeof(s_item_data) == (Enums::k_object_size_item - Enums::k_object_size_object), STATIC_ASSERT_FAIL);
		...
		struct s_garbage_data
		{
			...
			PAD16;
			int32 _unused[5];
		}; static_assert(sizeof(s_garbage_data) == (Enums::k_object_size_garbage - Enums::k_object_size_item), STATIC_ASSERT_FAIL);
		...
		struct s_item_datum
		{
			...
			s_item_data item;
		}; static_assert(sizeof(s_item_datum) == Enums::k_object_size_item, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_garbage_datum) == Enums::k_object_size_garbage, STATIC_ASSERT_FAIL);
	};
};