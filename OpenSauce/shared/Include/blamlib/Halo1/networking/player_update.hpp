...
namespace Yelo
{
	...
	namespace Networking
	{
		...
		}; static_assert(sizeof(s_remote_player_action_update_header) == 0x6, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_remote_player_action_update_network_data) == 0x30, STATIC_ASSERT_FAIL);

		struct s_remote_player_position_update_network_data
		{
			real_point3d position;
		}; static_assert(sizeof(s_remote_player_position_update_network_data) == 0xC, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_remote_player_vehicle_update_network_data) == 0x40, STATIC_ASSERT_FAIL);
	};
};