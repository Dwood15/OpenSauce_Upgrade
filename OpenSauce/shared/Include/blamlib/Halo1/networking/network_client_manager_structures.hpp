...
namespace Yelo
{
	namespace Networking
	{
		...
		struct s_network_game_client
		{
			...
			}; static_assert(sizeof(s_join_parameters) == 0x24, STATIC_ASSERT_FAIL);
			struct s_join_data
			{
				...
				PAD16;
			}; static_assert(sizeof(s_join_data) == 0x34, STATIC_ASSERT_FAIL);
			...
			}; static_assert(sizeof(s_ping_target) == 0x10, STATIC_ASSERT_FAIL);
			...
			PAD24;
		}; static_assert(sizeof(s_network_game_client) == 0xF90, STATIC_ASSERT_FAIL);
