...
namespace Yelo {
	namespace Networking {
		...
		}; static_assert(sizeof(message_server_game_update) == 0x10 + (sizeof(Players::s_player_action) * Enums::k_multiplayer_maximum_players));
		...
		}; static_assert( sizeof(message_client_game_update) == (0x8 + (sizeof(Players::s_player_action) * Enums::k_maximum_number_of_local_players)));
	};
};