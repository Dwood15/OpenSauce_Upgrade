...
namespace Yelo {
	namespace Networking {
		...
		}; BOOST_STATIC_ASSERT(sizeof(message_server_game_update) == 0x10 + (sizeof(Players::s_player_action) * Enums::k_multiplayer_maximum_players));
		...
		}; BOOST_STATIC_ASSERT( sizeof(message_client_game_update) == (0x8 + (sizeof(Players::s_player_action) * Enums::k_maximum_number_of_local_players)));
	};
};