...
namespace Yelo
{
	...
	public:
		...
		tag group_tag;
	}; static_assert(sizeof(tag_information) == 0x14, STATIC_ASSERT_FAIL);
	...
	}; static_assert(sizeof(field_information) == 0x1C, STATIC_ASSERT_FAIL);
	...
	}; static_assert(sizeof(block_information) == 0x28, STATIC_ASSERT_FAIL);
};