...
namespace Yelo {
	...
	namespace GameUI {
		...
		}; BOOST_STATIC_ASSERT(sizeof(s_first_render_time) == (sizeof(game_ticks_t) * 0x3)); //0xC
		...
		}; BOOST_STATIC_ASSERT(sizeof(s_hud_unit_interface) == 0x4 + (sizeof(s_hud_unit_interface_unit) * Enums::k_maximum_number_of_local_players)); //should be == 0x5c
