...
namespace Yelo
{
	...
	namespace TagGroups
	{
		struct s_damage_effect
		{
			...
			TAG_PAD(int32, 5);
		}; static_assert(sizeof(s_damage_effect) == 0x24, STATIC_ASSERT_FAIL);
		...
		struct s_damage_camera_effect
		{
			...
			TAG_PAD(int32, 5);
			TAG_PAD(int32, 2);
		}; static_assert(sizeof(s_damage_camera_effect) == 0x58, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_damage_breaking_effect) == 0xA0, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_damage_definition) == 0x3C, STATIC_ASSERT_FAIL);

		struct s_damage_modifiers
		{
			real modifier[Enums::k_number_of_material_types];
			TAG_PAD(int32, 7);
		}; static_assert(sizeof(s_damage_modifiers) == 0xA0, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_damage_effect_definition) == 0x2A0, STATIC_ASSERT_FAIL);
		...
		struct s_continuous_damage_effect_definition
		{
			...
			s_damage_definition damage;
			s_damage_modifiers damage_modifiers;
		}; static_assert(sizeof(s_continuous_damage_effect_definition) == 0x200, STATIC_ASSERT_FAIL);
	};
};