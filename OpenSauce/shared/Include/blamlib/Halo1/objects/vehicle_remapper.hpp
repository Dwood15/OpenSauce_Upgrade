...
namespace Yelo
{
	...
	namespace Objects
	{
		struct s_vehicle_set
		{
			...
			unsigned custom3 : 3;
			unsigned pad : 1;
		}; static_assert(sizeof(s_vehicle_set) == sizeof(int32), STATIC_ASSERT_FAIL);
		...
		}; static_assert( sizeof(s_vehicle_remapper) == 0xA0 );
		struct s_vehicle_remapper_globals
		{
			...
			bool processed;
			bool is_teamplay;
		}; static_assert( sizeof(s_vehicle_remapper_globals) == 0x3C2 );
	};
};