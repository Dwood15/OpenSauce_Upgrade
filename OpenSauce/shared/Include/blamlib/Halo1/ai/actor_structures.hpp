...
namespace Yelo
{
	namespace AI
	{
		...
		}; static_assert(sizeof(s_actor_state_data) == 0xB4, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_actor_input_data) == 0xA8, STATIC_ASSERT_FAIL);
		...
		struct s_actor_target_data
		{
			...
			PAD8; // unknown field
			PAD8; // unknown field
		}; static_assert(sizeof(s_actor_target_data) == 0x18, STATIC_ASSERT_FAIL);
		...
		struct s_actor_danger_zone_data
		{
			...
			PAD8; // unknown field
			PAD8; // unknown field
		}; static_assert(sizeof(s_actor_danger_zone_data) == 0x6C, STATIC_ASSERT_FAIL);
		...
		struct s_actor_stimulus_data
		{
			...
			PAD16; // unknown field
			PAD32; // unknown field
		}; static_assert(sizeof(s_actor_stimulus_data) == 0x64, STATIC_ASSERT_FAIL);
		...
		struct s_actor_emotion_data
		{
			...
			PAD32; // unknown field
			PAD32; // unknown field
		}; static_assert(sizeof(s_actor_emotion_data) == 0x68, STATIC_ASSERT_FAIL);
		...
		struct s_actor_firing_position_data
		{
			...
			PAD8; // unknown field
			PAD8; // unknown field
		}; static_assert(sizeof(s_actor_firing_position_data) == 0x30, STATIC_ASSERT_FAIL);
		...
		struct s_actor_orders_data
		{
			...
			PAD8; // unknown field
			PAD8; // unknown field
		}; static_assert(sizeof(s_actor_orders_data) == 0x84, STATIC_ASSERT_FAIL);
		...
		struct s_path
		{
			...
			PAD(4, 16);															//	0x3C
			PAD(5, 16);															//	0x4C
		}; static_assert(sizeof(s_path) == 0x5C, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_actor_control_direction_specification) == 0x10, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_actor_control_data) == 0x2B8, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_actor_datum) == 0x724, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_swarm_datum) == 0x98, STATIC_ASSERT_FAIL);
