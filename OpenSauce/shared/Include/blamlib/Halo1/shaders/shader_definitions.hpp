...
namespace Yelo
{
	...
	namespace TagGroups
	{
		...
		}; static_assert(sizeof(s_shader_animation_function) == 16, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_shader_texture_animation_function) == 12, STATIC_ASSERT_FAIL);
		struct s_shader_scaled_map
		{
			TAG_FIELD(real, scale, "", "0 defaults to 1");
			TAG_FIELD(tag_reference, map, 'bitm');
		}; static_assert(sizeof(s_shader_scaled_map) == 20, STATIC_ASSERT_FAIL);
		struct s_shader_color_function
		{
			...
			TAG_PAD(int32, 6);
		}; static_assert(sizeof(s_shader_color_function) == 60, STATIC_ASSERT_FAIL);
		struct s_shader_shader_framebuffer_function
		{
			...
			PAD16;
		}; static_assert(sizeof(s_shader_shader_framebuffer_function) == 8, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_shader_radiosity_properties) == 12, STATIC_ASSERT_FAIL);
		//////////////////////////////////////////////////////////////////////////
		struct _shader_definition
		{
			...
			{
				TAG_FLAG16(unused);
			}; static_assert(sizeof(__flags_1) == sizeof(word_flags), STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(_shader_definition) == 0x28, STATIC_ASSERT_FAIL);
		...
		struct _shader_effect_definition
		{
			...
			}; static_assert(sizeof(_map_flags) == sizeof(word_flags), STATIC_ASSERT_FAIL);
			...
			PAD128; PAD32;
		}; static_assert(sizeof(_shader_effect_definition) == 0x8C, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_shader_effect) == 0xB4, STATIC_ASSERT_FAIL);
		...
		struct s_shader_environment_extension
		{
			...
			}; static_assert(sizeof(__specular_color_flags) == sizeof(word_flags), STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(_shader_environment_definition) == 0x31C, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_shader_environment_definition) == 0x344, STATIC_ASSERT_FAIL); // max count: 1
		//////////////////////////////////////////////////////////////////////////
		struct s_shader_model_extension
		{
			...
			}; static_assert(sizeof(__diffuse_lighting_flags) == sizeof(word_flags), STATIC_ASSERT_FAIL);
		...
		struct _shader_model_definition
		{
			...
			TAG_PAD(int32, 4);
			TAG_PAD(int32, 8);			
		}; static_assert(sizeof(_shader_model_definition) == 0x190, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_shader_model_definition) == 0x1B8, STATIC_ASSERT_FAIL); // max count: 1
		//////////////////////////////////////////////////////////////////////////
		struct s_shader_transparent_layer
		{
			TAG_FIELD(tag_reference, shader, 'shdr');
		}; static_assert(sizeof(s_shader_transparent_layer) == 0x10, STATIC_ASSERT_FAIL); // max count: 4
		...
		}; static_assert(sizeof(s_shader_transparent_chicago_map) == 0xDC, STATIC_ASSERT_FAIL); // max count: 4
		struct s_shader_transparent_chicago_base
		{
			...
			}; static_assert(sizeof(__extra_flags) == sizeof(long_flags), STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_shader_transparent_chicago_definition) == 0x6C, STATIC_ASSERT_FAIL); // max count: 1
		//////////////////////////////////////////////////////////////////////////
		...
		}; static_assert(sizeof(s_shader_transparent_chicago_extended_definition) == 0x78, STATIC_ASSERT_FAIL); // max count: 1
		//////////////////////////////////////////////////////////////////////////
		struct s_shader_transparent_generic_map
		{
			...
			// 2D texture animation
			s_shader_animation map_animation;
		}; static_assert(sizeof(s_shader_transparent_generic_map) == 0x64, STATIC_ASSERT_FAIL); // max count: 4
		...
		}; static_assert(sizeof(s_shader_transparent_generic_stage) == 0x70, STATIC_ASSERT_FAIL); // max count: 7
		...
		}; static_assert(sizeof(s_shader_transparent_generic_definition) == 0x6C, STATIC_ASSERT_FAIL); // max count: 1
		//////////////////////////////////////////////////////////////////////////
		...
		}; static_assert(sizeof(s_shader_transparent_glass_definition) == 0x1E0, STATIC_ASSERT_FAIL); // max count: 1
		//////////////////////////////////////////////////////////////////////////
		...
		}; static_assert(sizeof(s_shader_transparent_meter_definition) == 0x104, STATIC_ASSERT_FAIL); // max count: 1
		//////////////////////////////////////////////////////////////////////////
		...
		}; static_assert(sizeof(s_shader_transparent_plasma_definition) == 0x14C, STATIC_ASSERT_FAIL); // max count: 1
		//////////////////////////////////////////////////////////////////////////
		struct s_shader_transparent_water_ripple
		{
			...
			TAG_PAD(int32, 4);
		}; static_assert(sizeof(s_shader_transparent_water_ripple) == 0x4C, STATIC_ASSERT_FAIL); // max count: 4
		...
		}; static_assert(sizeof(s_shader_transparent_water_definition) == 0x140, STATIC_ASSERT_FAIL); // max count: 1
		//////////////////////////////////////////////////////////////////////////
	};
};