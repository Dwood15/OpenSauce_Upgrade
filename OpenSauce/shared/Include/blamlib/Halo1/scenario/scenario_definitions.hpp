...
namespace Yelo
{
	...
	namespace TagGroups
	{
		struct scenario_starting_profile
		{
			...
			TAG_PAD(int32, 5);
		}; static_assert(sizeof(scenario_starting_profile) == 0x68, STATIC_ASSERT_FAIL);
		...
		struct scenario_player
		{
			...
			TAG_PAD(int32, 6);
		}; static_assert(sizeof(scenario_player) == 0x34, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(scenario_trigger_volume) == 0x60, STATIC_ASSERT_FAIL);
		...
		struct scenario_netpoint
		{
			...
			TAG_PAD(int32, 28);
		}; static_assert(sizeof(scenario_netpoint) == 0x94, STATIC_ASSERT_FAIL);
		...
		struct scenario_netgame_equipment
		{
			...
			TAG_PAD(int32, 12);
		}; static_assert(sizeof(scenario_netgame_equipment) == 0x90, STATIC_ASSERT_FAIL);
		...
		struct scenario_starting_equipment
		{
			...
			TAG_PAD(int32, 12);
		}; static_assert(sizeof(scenario_starting_equipment) == 0xCC, STATIC_ASSERT_FAIL);
		...
		struct scenario_cutscene_flag
		{
			...
			TAG_PAD(int32, 9);
		}; static_assert(sizeof(scenario_cutscene_flag) == 0x5C, STATIC_ASSERT_FAIL);
		...
		struct scenario_cutscene_camera_point
		{
			...
			TAG_PAD(int32, 9);
		}; static_assert(sizeof(scenario_cutscene_camera_point) == 0x68, STATIC_ASSERT_FAIL);
		...
		struct s_scenario_cutscene_title
		{
			...
			TAG_PAD(int32, 4);
		}; static_assert(sizeof(s_scenario_cutscene_title) == 0x60, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(scenario_structure_bsp_reference) == 0x20, STATIC_ASSERT_FAIL); // max count: 32
		...
		}; static_assert(sizeof(scenario) == 0x5B0, STATIC_ASSERT_FAIL);
	};
};