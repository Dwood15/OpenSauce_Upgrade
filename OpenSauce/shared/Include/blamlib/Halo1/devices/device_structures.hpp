...
namespace Yelo
{
	...
	namespace Objects
	{
		...
		}; static_assert(sizeof(s_device_data) == Enums::k_object_size_device - Enums::k_object_size_object, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_device_machine_data) == Enums::k_object_size_machine - Enums::k_object_size_device, STATIC_ASSERT_FAIL);
		...
		struct s_device_control_data
		{
			...
			PAD16;
		}; static_assert(sizeof(s_device_control_data) == Enums::k_object_size_control - Enums::k_object_size_device, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_device_lightfixture_data) == Enums::k_object_size_light_fixture - Enums::k_object_size_device, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_device_datum) == Enums::k_object_size_device, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_device_machine_datum) == Enums::k_object_size_machine, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_device_control_datum) == Enums::k_object_size_control, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_device_lightfixture_datum) == Enums::k_object_size_light_fixture, STATIC_ASSERT_FAIL);
	};
};