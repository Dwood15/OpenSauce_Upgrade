...
namespace Yelo
{
	...
	namespace Objects
	{
		...
		}; static_assert( sizeof(s_device_lightfixture_data) == Enums::k_object_size_light_fixture - Enums::k_object_size_device );
		...
		}; static_assert( sizeof(s_device_datum) == Enums::k_object_size_device );
		...
		}; static_assert( sizeof(s_device_machine_datum) == Enums::k_object_size_machine );
		...
		}; static_assert( sizeof(s_device_control_datum) == Enums::k_object_size_control );
		...
		}; static_assert( sizeof(s_device_lightfixture_datum) == Enums::k_object_size_light_fixture );
	};
};