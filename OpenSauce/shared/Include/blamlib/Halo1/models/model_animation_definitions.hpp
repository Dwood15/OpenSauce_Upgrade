...
namespace Yelo
{
	...
	namespace TagGroups
	{
		...
		}; static_assert(sizeof(animation_graph_weapon_type) == 0x3C, STATIC_ASSERT_FAIL); // max count: 16
		...
		}; static_assert(sizeof(animation_graph_weapon) == 0xBC, STATIC_ASSERT_FAIL); // max count: 16
		...
		}; static_assert(sizeof(animation_graph_unit_seat) == 0x64, STATIC_ASSERT_FAIL); // max count: 32
		...
		}; static_assert(sizeof(model_animation) == 0xB4, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(model_animation_graph) == 0x80, STATIC_ASSERT_FAIL);
	};
};