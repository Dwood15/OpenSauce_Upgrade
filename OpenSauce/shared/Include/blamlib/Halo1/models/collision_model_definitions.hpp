...
namespace Yelo
{
	...
	namespace TagGroups
	{
		...
		struct s_damage_resistance // or s_model_damage_info
		{
			...
			TAG_PAD(int32, 3);
			TAG_PAD(int32, 28);
		}; static_assert( sizeof(s_damage_resistance) == 0x234, "s_damage_resistance");
		...
		}; static_assert(sizeof(collision_model_material) == 0x48, "collision_model_material");
		...
		}; static_assert( sizeof(collision_model_region) == 0x54, "collision_model_region" ); // aka damage region
		...
		}; static_assert( sizeof(collision_model_pathfinding_sphere) == 0x20, "collision_model_pathfinding_sphere" );
		...
		}; static_assert( sizeof(collision_model_node) == 0x40, "collision_model_node" );
		...
		}; static_assert(sizeof(collision_model_definition) == 0x298, STATIC_ASSERT_FAIL);
	};
};