...
namespace Yelo {
	...
	namespace Players {
		...
		}; static_assert(sizeof(s_player_control_globals_data) == (0x10 + sizeof(s_player_control)* Enums::k_maximum_number_of_local_players), STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_unit_camera_info) == 0x18, STATIC_ASSERT_FAIL);
