...
namespace Yelo
{
	namespace TagGroups
	{
		...
		}; static_assert(sizeof(s_game_globals_difficulty_information) <= 0x284, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_game_globals_grenade) == 0x44, STATIC_ASSERT_FAIL);
		...
		struct s_game_globals_multiplayer_information
		{
			...
			TAG_PAD(int32, 14);
		}; static_assert(sizeof(s_game_globals_multiplayer_information) == 0xA0, STATIC_ASSERT_FAIL);
		...
		struct s_game_globals_player_information
		{
			...
			TAG_PAD(int32, 11);
		}; static_assert(sizeof(s_game_globals_player_information) == 0xF4, STATIC_ASSERT_FAIL);
		...
		struct s_game_globals_player_representation // game_globals_first_person_interface
		{
			...
			TAG_PAD(int32, 22);
		}; static_assert(sizeof(s_game_globals_player_representation) == 0xC0, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_game_globals_falling_damage) == 0x98, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(material_definition) == 0x374, STATIC_ASSERT_FAIL);
		...
		}; static_assert(sizeof(s_game_globals) == 0x1AC, STATIC_ASSERT_FAIL);
	};
};