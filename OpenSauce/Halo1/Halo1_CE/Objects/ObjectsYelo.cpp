...
#include <YeloLib/Halo1/render/render_objects_upgrades.inl>
		...
		static void UseBipedJumpPenalty(bool use_fix)
		{
			...
			static_assert(k_game_globals_player_stun_turning_penalty_offset == 0x84, STATIC_ASSERT_FAIL);
			static_assert(k_game_globals_player_stun_jumping_penalty_offset == 0x88, STATIC_ASSERT_FAIL);
