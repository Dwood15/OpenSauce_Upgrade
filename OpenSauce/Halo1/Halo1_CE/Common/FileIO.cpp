...
namespace Yelo::FileIO
{
#pragma region XML containers
	class c_file_container : public Configuration::c_configuration_container
	{
	public:
		...
		c_file_container() : Configuration::c_configuration_container("File"), m_id("ID", ""), m_md5("MD5", ""), m_path("Path", "") { }
	...
	protected:
		std::vector<Configuration::i_configuration_value*> GetMembers() final override
		{
