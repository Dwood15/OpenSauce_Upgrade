...
namespace Yelo::Main {
	...
	static Yelo::Enums::version_result_code GetVersionResultCode() {
		Yelo::Enums::version_result_code    result_code = Enums::_version_result_code_invalid;
