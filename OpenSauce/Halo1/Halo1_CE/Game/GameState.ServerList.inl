...
static void* CreateNetworkServerHook() {
	...
	static const create_network_game_t network_game_server_create=CAST_PTR(create_network_game_t, GET_FUNC_VPTR(GAME_CREATE_NETWORK_SERVER));
...
static void* CreateNetworkClientHook() {
	typedef void* (PLATFORM_API* create_network_game_t)();
	static const create_network_game_t network_game_client_create=CAST_PTR(create_network_game_t, GET_FUNC_VPTR(GAME_CREATE_NETWORK_CLIENT));
